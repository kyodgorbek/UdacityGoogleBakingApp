...
//        }
    ...
    public RemoteViews getViewAt(int position) {
        final RemoteViews remoteViews = new RemoteViews(context.getPackageName(), com.edgar.yodgorbekkomilov.yodgorbekkomilov.R.layout.list_rows);
        Ingredient ingredient = ingredients.get(position);

        remoteViews.setTextViewText(com.edgar.yodgorbekkomilov.yodgorbekkomilov.R.id.recipe, ingredient.getIngredient());
        return remoteViews;
    }
