...
public class RecipeWidgetProvider extends AppWidgetProvider {
    ...
    //prefsEditor.commit();
        ...
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), com.edgar.yodgorbekkomilov.yodgorbekkomilov.R.layout.recipe_widget);
        Intent svcIntent = new Intent(context, WidgetService.class);
        svcIntent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId);
        svcIntent.setData(Uri.parse(svcIntent.toUri(Intent.URI_INTENT_SCHEME)));
        remoteViews.setRemoteAdapter(appWidgetId, com.edgar.yodgorbekkomilov.yodgorbekkomilov.R.id.listViewWidget, svcIntent);
        remoteViews.setEmptyView(com.edgar.yodgorbekkomilov.yodgorbekkomilov.R.id.listViewWidget, com.edgar.yodgorbekkomilov.yodgorbekkomilov.R.id.empty_view);
